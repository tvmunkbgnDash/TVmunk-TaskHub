...
const initialData = {
  users: [
    ...
    },
    {
      ...
      department: 'กราฟิก',
      bu: 'bgn squad',
      avatar: generateMeepleSvg({ color: 'yellow', face: 'blush', accessory: 'flower' }),
      email: 'trainee.graphic@tvmunk.com',
      joinedYear: 2025,
      joinedDate: '2025-01-01',
      leaveQuota: 9
    },
    ...
    },
    {
      ...
      department: 'วิดีโอ/ตัดต่อ',
      bu: 'bgn squad',
      avatar: generateMeepleSvg({ color: 'teal', face: 'cool', accessory: 'glasses' }),
      email: 'bank@tvmunk.com',
      joinedYear: 2025,
      joinedDate: '2025-01-01',
      leaveQuota: 9
    },
    {
      ...
      department: 'คอนเทนต์',
      bu: 'bgn squad',
      avatar: generateMeepleSvg({ color: 'amber', face: 'happy', accessory: 'star' }),
      email: 'trong@tvmunk.com',
      joinedYear: 2025,
      joinedDate: '2025-01-01',
      leaveQuota: 9
    },
    ...
    },
    {
      ...
      department: 'การตลาด',
      bu: 'bgn square',
      avatar: generateMeepleSvg({ color: 'rose', face: 'sparkle', accessory: 'bowtie' }),
      email: 'jaja@tvmunk.com',
      joinedYear: 2025,
      joinedDate: '2025-01-01',
      leaveQuota: 9
    },
...
class Database {
  ...
  createTask(taskData, creatorUser) {
    ...
    const newTask = {
      ...
      assignedMembers: taskData.assignedMembers || (taskData.assignedTo ? [taskData.assignedTo] : []),
